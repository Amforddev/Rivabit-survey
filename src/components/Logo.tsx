...
export function Logo({ className = "", showText = true }: LogoProps) {
  return (
    <div className={`flex items-center gap-1.5 ${className.includes('text-') ? className : `text-primary ${className}`}`}>
      <svg viewBox="0 0 100 100" className="h-full w-auto" fill="currentColor" overflow="visible">
        <defs>
          <mask id="face-mask">
        ...
        {/* Leaves */}
        <path d="M48 26 C43 18 35 15 32 18 C30 20 35 26 42 27 Z" fill="currentColor" />
        <path d="M52 26 C57 12 70 8 75 12 C78 15 65 25 55 28 Z" fill="currentColor" />
      </svg>
      {showText && (
